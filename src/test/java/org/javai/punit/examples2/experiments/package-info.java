 ...
 *
 * <h2>MEASURE Mode</h2>
 * <p>{@link org.javai.punit.examples2.experiments.ShoppingBasketMeasure} runs many
 ...
 *
 * <h2>EXPLORE Mode</h2>
 * <p>{@link org.javai.punit.examples2.experiments.ShoppingBasketExplore} compares
 ...
 * <ul>
 *   <li>{@link org.javai.punit.examples2.experiments.ShoppingBasketOptimizeTemperature} -
 *       Optimizes a numeric parameter (LLM temperature)</li>
 *   <li>{@link org.javai.punit.examples2.experiments.ShoppingBasketOptimizePrompt} -
 *       Optimizes text (system prompt) through iterative refinement</li>
 * </ul>
 *
 * <h2>Supporting Classes</h2>
 * <ul>
 *   <li>{@link org.javai.punit.examples2.experiments.SuccessRateScorer} - Scores
 *       optimization iterations by pass rate</li>
 *   <li>{@link org.javai.punit.examples2.experiments.TemperatureMutator} - Generates
 *       temperature variations for optimization</li>
 *   <li>{@link org.javai.punit.examples2.experiments.ShoppingBasketPromptMutator} -
