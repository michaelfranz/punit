 ...
 * <p>{@link org.javai.punit.examples.tests.ShoppingBasketThresholdApproachesTest}
 ...
 * <p>{@link org.javai.punit.examples.tests.ShoppingBasketCovariateTest} shows how
 ...
 * <ul>
 *   <li>{@link org.javai.punit.examples.tests.ShoppingBasketBudgetTest} - Token and
 *       time budgets for cost control</li>
 *   <li>{@link org.javai.punit.examples.tests.ShoppingBasketPacingTest} - Rate limiting
 *       for API compliance</li>
 * </ul>
 *
 * <h2>Error Handling</h2>
 * <p>{@link org.javai.punit.examples.tests.ShoppingBasketExceptionTest} demonstrates
 * strategies for handling exceptions: fail sample, propagate immediately, or ignore.
 *
 * <h2>SLA Verification</h2>
 * <p>{@link org.javai.punit.examples.tests.PaymentGatewaySlaTest} shows the
